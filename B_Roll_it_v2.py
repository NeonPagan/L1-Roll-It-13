...
while comp_score < game_goal and user_score < game_goal:
    ...
    if user_points < comp_points:
        print("You start because your initial was less than the computer")
    ...
    while player_1_points < 13 and player_2_points < 13:
        ...
        # first person rolls the die and the score are updated
...
if user_score > comp_score:
    make_statement("The User won", "👍")  # replace this with
else:
